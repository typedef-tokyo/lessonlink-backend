...
type IScheduleGetPresenter interface {
	Present(result *interactor.ScheduleGetOutput) *ScheduleGetResponse
}
...
func (h *ScheduleGetPresenter) Present(result *interactor.ScheduleGetOutput) *ScheduleGetResponse {
	...
	return &ScheduleGetResponse{
		...
		Rooms: lo.Map(result.Rooms, func(item interactor.ScheduleRoomDTO, _ int) ScheduleRoomDTO {
