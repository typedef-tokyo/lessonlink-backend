...
type (
	...
	ScheduleItemMoveController struct {
		inputPort interactor.IScheduleItemMoveInputPort
...
func (h *ScheduleItemMoveController) Execute(c echo.Context) error {
	...
	result, err := h.inputPort.Execute(c.Request().Context(), userID, scheduleID, requestData.HistoryIndex, interactor.ScheduleItemMoveInput{
