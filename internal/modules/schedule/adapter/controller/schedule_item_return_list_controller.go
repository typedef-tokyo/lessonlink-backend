...
type (
	...
	ScheduleItemReturnListController struct {
		inputPort interactor.IScheduleItemReturnListInputPort
...
func (h *ScheduleItemReturnListController) Execute(c echo.Context) error {
	...
	result, err := h.inputPort.Execute(c.Request().Context(), userID, scheduleID, requestData.HistoryIndex, interactor.ScheduleItemReturnListInput{
